...
static void event_handler_cb_settings_system_txt_firmware_version_controller(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
            const char *value = lv_textarea_get_text(ta);
            set_var_s_firmware_version_controller(value);
        }
    }
}

static void event_handler_cb_settings_system_txt_firmware_version_remote(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
            const char *value = lv_textarea_get_text(ta);
            set_var_s_firmware_version_remote(value);
        }
    }
}
...
static void event_handler_cb_settings_model_obj22(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_model_obj23(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_model_obj24(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_model_obj25(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_model_obj26(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_model_obj27(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_model_obj28(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_model_obj29(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_model_obj30(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_model_obj31(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_pump_obj2(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_calib_volt_txt_calib_volt(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
            const char *value = lv_textarea_get_text(ta);
            set_var_s_akku_volt_messure(value);
        }
    }
}
...
void create_screen_settings_system() {
    ...
    lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_border_width(obj, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_imagebutton_set_src(obj, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &img_settings, NULL);
                    lv_obj_add_event_cb(obj, action_view_calib_volt, LV_EVENT_CLICKED, (void *)0);
                }
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    add_style_label_style(obj);
                    lv_label_set_text(obj, "FW Version - Controller");
                }
                {
                    // txtFirmwareVersionController
                    lv_obj_t *obj = lv_textarea_create(parent_obj);
                    objects.txt_firmware_version_controller = obj;
                    lv_obj_set_pos(obj, 446, 635);
                    lv_obj_set_size(obj, 324, 47);
                    lv_textarea_set_max_length(obj, 15);
                    lv_textarea_set_placeholder_text(obj, "---");
                    lv_textarea_set_one_line(obj, true);
                    lv_textarea_set_password_mode(obj, false);
                    lv_obj_add_event_cb(obj, event_handler_cb_settings_system_txt_firmware_version_controller, LV_EVENT_ALL, 0);
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    add_style_label_style(obj);
                    lv_label_set_text(obj, "FW Version - Remote");
                }
                {
                    // txtFirmwareVersionRemote
                    lv_obj_t *obj = lv_textarea_create(parent_obj);
                    objects.txt_firmware_version_remote = obj;
                    lv_obj_set_pos(obj, 446, 685);
                    lv_obj_set_size(obj, 324, 47);
                    lv_textarea_set_max_length(obj, 15);
                    lv_textarea_set_placeholder_text(obj, "---");
                    lv_textarea_set_one_line(obj, true);
                    lv_textarea_set_password_mode(obj, false);
                    lv_obj_add_event_cb(obj, event_handler_cb_settings_system_txt_firmware_version_remote, LV_EVENT_ALL, 0);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICKABLE);
                    add_style_textbox(obj);
                }
                {
                    lv_obj_t *obj = lv_button_create(parent_obj);
                    lv_obj_set_pos(obj, 0, 789);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_keyboard(obj, 26);
        }
        {
            // contNumpadSettings
            lv_obj_t *obj = lv_obj_create(parent_obj);
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_numpad(obj, 28);
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.obj4 = obj;
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_save(obj, 30);
            {
                lv_obj_t *parent_obj = obj;
                {
                    lv_obj_t *obj = lv_button_create(parent_obj);
        ...
        {
            // contCalibVoltSettings
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.cont_calib_volt_settings = obj;
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, 800, 480);
            lv_obj_set_style_pad_left(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_top(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_calib_volt(obj, 32);
        }
    }
...
void tick_screen_settings_system() {
    tick_user_widget_header(10);
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.txt_owner);
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.txt_sys_power_off_time);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.txt_flow_ticks);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.txt_pressure_avg);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.txt_akku_min_v);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.txt_pump_pwr_calib);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.txt_pump_pwr_manu);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    {
        const char *new_val = get_var_s_firmware_version_controller();
        const char *cur_val = lv_textarea_get_text(objects.txt_firmware_version_controller);
        uint32_t max_length = lv_textarea_get_max_length(objects.txt_firmware_version_controller);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.txt_firmware_version_controller;
            lv_textarea_set_text(objects.txt_firmware_version_controller, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        const char *new_val = get_var_s_firmware_version_remote();
        const char *cur_val = lv_textarea_get_text(objects.txt_firmware_version_remote);
        uint32_t max_length = lv_textarea_get_max_length(objects.txt_firmware_version_remote);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.txt_firmware_version_remote;
            lv_textarea_set_text(objects.txt_firmware_version_remote, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    tick_user_widget_save(30);
    {
        bool new_val = get_var_b_hide_cont_calib_volt();
        bool cur_val = lv_obj_has_flag(objects.cont_calib_volt_settings, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.cont_calib_volt_settings;
            if (new_val) lv_obj_add_flag(objects.cont_calib_volt_settings, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.cont_calib_volt_settings, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    tick_user_widget_calib_volt(32);
}
...
void create_screen_model_select() {
    ...
    add_style_page_style(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_header(obj, 42);
        }
        {
            // contModels
            lv_obj_t *obj = lv_obj_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_wait(obj, 50);
        }
    }
...
void create_screen_settings_model() {
    ...
    add_style_page_style(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_header(obj, 59);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
        {
            // contModelSettings
                ...
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj22, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_DEFOCUSED, (void *)0);
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj23, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_go2home, LV_EVENT_DEFOCUSED, (void *)0);
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj24, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
                ...
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_DEFOCUSED, (void *)0);
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj25, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_DEFOCUSED, (void *)0);
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj26, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_DEFOCUSED, (void *)0);
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj27, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_DEFOCUSED, (void *)0);
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj28, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
                ...
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_DEFOCUSED, (void *)0);
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj29, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_DEFOCUSED, (void *)0);
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj30, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
                {
                    ...
                    add_style_container_settings(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_DEFOCUSED, (void *)0);
                            lv_obj_add_event_cb(obj, action_numpad_show, LV_EVENT_FOCUSED, (void *)1);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_model_obj31, LV_EVENT_ALL, 0);
                            add_style_textbox(obj);
                        }
                    }
                }
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_keyboard(obj, 83);
        }
        {
            // contNumpadModel
            lv_obj_t *obj = lv_obj_create(parent_obj);
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_numpad(obj, 85);
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.obj32 = obj;
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_save(obj, 87);
            {
                lv_obj_t *parent_obj = obj;
                {
                    lv_obj_t *obj = lv_button_create(parent_obj);
...
void tick_screen_settings_model() {
    ...
    }
    {
        if (!(lv_obj_get_state(objects.obj16) & LV_STATE_EDITED)) {
            ...
            int32_t cur_val = lv_dropdown_get_selected(objects.obj16);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj16;
                lv_dropdown_set_selected(objects.obj16, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.obj17);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.obj18);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.obj20);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj22);
        uint32_t max_length = lv_textarea_get_max_length(objects.obj22);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.obj22;
            lv_textarea_set_text(objects.obj22, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj23);
        uint32_t max_length = lv_textarea_get_max_length(objects.obj23);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.obj23;
            lv_textarea_set_text(objects.obj23, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj24);
        uint32_t max_length = lv_textarea_get_max_length(objects.obj24);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.obj24;
            lv_textarea_set_text(objects.obj24, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        uint32_t max_length = lv_textarea_get_max_length(objects.obj25);
        if (strncmp(new_val, cur_val, max_length) != 0) {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj26);
        uint32_t max_length = lv_textarea_get_max_length(objects.obj26);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.obj26;
            lv_textarea_set_text(objects.obj26, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj27);
        uint32_t max_length = lv_textarea_get_max_length(objects.obj27);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.obj27;
            lv_textarea_set_text(objects.obj27, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj28);
        uint32_t max_length = lv_textarea_get_max_length(objects.obj28);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.obj28;
            lv_textarea_set_text(objects.obj28, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj29);
        uint32_t max_length = lv_textarea_get_max_length(objects.obj29);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.obj29;
            lv_textarea_set_text(objects.obj29, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj30);
        uint32_t max_length = lv_textarea_get_max_length(objects.obj30);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.obj30;
            lv_textarea_set_text(objects.obj30, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj31);
        uint32_t max_length = lv_textarea_get_max_length(objects.obj31);
        if (strncmp(new_val, cur_val, max_length) != 0) {
            tick_value_change_obj = objects.obj31;
            lv_textarea_set_text(objects.obj31, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void create_screen_pump() {
    ...
    add_style_page_style(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_header(obj, 108);
        }
        {
            // contPumpMain
            lv_obj_t *obj = lv_obj_create(parent_obj);
            ...
            lv_obj_set_style_border_side(obj, LV_BORDER_SIDE_FULL, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_add_event_cb(obj, event_handler_cb_pump_obj2, LV_EVENT_ALL, 0);
...
void tick_screen_pump() {
    ...
    {
        const char *new_val = get_var_s_rest_tank_time();
...
void create_user_widget_calib_volt(lv_obj_t *parent_obj, int startWidgetIndex) {
    ...
    lv_obj_t *obj = parent_obj;
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_t *obj = lv_win_create(parent_obj);
            ((lv_obj_t **)&objects)[startWidgetIndex + 0] = obj;
            lv_obj_set_pos(obj, 379, 43);
            lv_obj_set_size(obj, 400, 395);
            lv_obj_set_style_border_width(obj, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
            lv_obj_set_pos(obj, 447, 56);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            add_style_label_style(obj);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_48, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "Kalibrieren");
        ...
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
            lv_obj_set_pos(obj, 417, 152);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            add_style_label_style(obj);
            lv_label_set_text(obj, "gemessene Spannug (V)");
        }
        {
            // txtCalibVolt
            lv_obj_t *obj = lv_textarea_create(parent_obj);
            ((lv_obj_t **)&objects)[startWidgetIndex + 1] = obj;
            lv_obj_set_pos(obj, 417, 185);
            lv_obj_set_size(obj, 324, 47);
            lv_textarea_set_accepted_chars(obj, ".0123456789");
            lv_textarea_set_max_length(obj, 5);
            lv_textarea_set_placeholder_text(obj, "xx.xx Volt");
            lv_textarea_set_one_line(obj, true);
            lv_textarea_set_password_mode(obj, false);
            lv_obj_add_event_cb(obj, event_handler_cb_calib_volt_txt_calib_volt, LV_EVENT_ALL, 0);
            lv_obj_add_state(obj, LV_STATE_FOCUSED);
            add_style_textbox(obj);
        }
        {
            lv_obj_t *obj = lv_button_create(parent_obj);
            lv_obj_set_pos(obj, 594, 337);
            lv_obj_set_size(obj, 147, 61);
            lv_obj_add_event_cb(obj, action_event_button_click, LV_EVENT_CLICKED, (void *)14);
            {
                lv_obj_t *parent_obj = obj;
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
...
void tick_user_widget_calib_volt(int startWidgetIndex) {
    (void)startWidgetIndex;
    {
        const char *new_val = get_var_s_akku_volt_messure();
